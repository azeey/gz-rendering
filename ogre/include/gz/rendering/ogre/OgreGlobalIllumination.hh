...
#ifndef GZ_RENDERING_OGRE_OGREGLOBALILLUMINATION_HH_
#define GZ_RENDERING_OGRE_OGREGLOBALILLUMINATION_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    class OgreGlobalIllumination :
      public GlobalIllumination
    {
      public: OgreGlobalIllumination();

      public: virtual ~OgreGlobalIllumination();
    };
    }
  }
}
